    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            float deltaX = mXAxis != null
                    ? mXAxis.mAxisRange
                    : ((mData == null ? 0.f : mData.getDataSetCount()) - 1.f);
...
//                float[] pos = getMarkerPosition(e,highlight);
                ...
                if (null != myMarkerViewH) {
                    ...
                    myMarkerViewH.draw(canvas, mViewPortHandler.contentLeft(), mIndicesToHighlight[i].getY() - myMarkerViewH.getHeight() / 2);
                }
                ...
                if (null != myMarkerViewLeft) {
                    ...
                    myMarkerViewLeft.draw(canvas, mViewPortHandler.contentLeft(), mIndicesToHighlight[i].getY() - myMarkerViewLeft.getHeight() / 2);
