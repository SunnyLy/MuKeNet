...
public class DataParse {
    ...
    public void parseKLine(JSONObject obj) {
        ...
        if (list != null) {
            ...
            Logger.e("DataParse" + "假数据条数:" + count);
            for (int i = 0; i < count; i++) {
    ...
    public void initLineDatas(ArrayList<KLineBean> datas) {
        ...
        for (int i = 0, j = 0; i < datas.size(); i++, j++) {
            ...
            barEntries.add(new BarEntry(i, new float[]{datas.get(i).high, datas.get(i).low, datas.get(i).open, datas.get(i).close, datas.get(i).vol}));
    ...
    public void initKLineMA(ArrayList<KLineBean> datas) {
        Logger.e("initKLineMA=====" + System.currentTimeMillis());
...
//            ma30DataL.add(new Entry(kmaEntity30.getMAs().get(i), i));
        ...
        Logger.e("initKLineMA=====" + System.currentTimeMillis() + ",ma30DataL:" + ma30DataL.size());
    }
